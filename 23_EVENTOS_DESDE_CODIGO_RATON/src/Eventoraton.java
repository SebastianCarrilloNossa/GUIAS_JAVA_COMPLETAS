...
public class Eventoraton extends javax.swing.JFrame {
    ...
    public void etiZonaMouseEntered(MouseEvent evt){
        etiTexto.setText("El raton acaba de entrar a la estiqueta");
    }
    ...
    public void etiZonaMousePressed(MouseEvent evt){
       if(evt.getButton()==MouseEvent.BUTTON1){
           etiTexto.setText("Se acaba de orpimir el boton izquierdo");
           }else if(evt.getButton()==MouseEvent.BUTTON2){
               etiTexto.setText("Se acaba de pulsarl el botol central");
